...
import { getHomePageHandler } from '@/common/requestHandler'
import TheNavBar from '@/components/TheNavBar.vue'
import TheHomeSearch from '@/components/TheHomeSearch.vue'
...
<template>
  ...
  <!-- ↓ 自定义导航 -->
  <the-nav-bar :title="'首页'" :back="false" :filter="true" :bg="true" />
